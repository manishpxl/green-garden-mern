            ...
            <div className="add-plant-wrapper">
                <div className="add-plant-layout">
                    <div className="add-plant-image-col">
                        <img src="/images/plant-leaf.jpg" alt="Plant Decoration" />
                    </div>
                        ...
                        <div className="add-plant-form-card">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="add-plant-form">
                                ...
                                <div className="form-group-single">
                                    ...
                                    <textarea rows="3" {...register('description', { required: 'Description is required' })}></textarea>
                                ...
                                <div className="form-row">
                                    <div className="form-group-half">
                                        ...
                                        <input type="number" {...register('stock', { required: 'Stock is required', min: { value: 0, message: "Cannot be negative" } })} />
                                        {errors.stock && <span className="error-text">{errors.stock.message}</span>}
                                    </div>
                                    <div className="form-group-half">
                                        <label>Price</label>
                                        <input type="number" {...register('price', { required: 'Price is required', min: { value: 1, message: "Must be > 0" } })} />
                                ...
                                <div className="form-group-single file-input-group">
                                ...
                                <div className="add-plant-actions">
                                    ...
                                    <button type="button" className="btn-add-cancel" onClick={() => navigate('/admin/view-plants')}>
                                        Cancel
                                    </button>
                                </div>
                            </form>
